...
public class CancelOrderDetailsPopupWindow extends PopupWindow {
    ...
    public CancelOrderDetailsPopupWindow(final Activity mActivity, final String id) {
...
//        });
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getCancel(id, SharedUtil.getToken(mActivity),tv1.getText().toString());
        ...
        tv2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getCancel(id, SharedUtil.getToken(mActivity),tv2.getText().toString());
                dismiss();
                setBackgroundAlpha(mActivity,1.0f);
            }
        });
        tv3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getCancel(id, SharedUtil.getToken(mActivity),tv3.getText().toString());
                dismiss();
                setBackgroundAlpha(mActivity,1.0f);
            }
        });
...
//        Log.e("学校", "设置了背景色"+bgAlpha);
    ...
    public void getCancel(String id,String token,String reason){
        ...
        final Retrofit retrofit = new Retrofit.Builder().
                ...
                .build();
        //3.准备请求网络
        CancelOrderPopupWindow.getCancelService service = retrofit.create(CancelOrderPopupWindow.getCancelService.class);
        //4.通过回调获得结果
            ...
            public void onResponse(Call<Code> call, Response<Code> response) {
                if (response.code()==200){
                    if (response.body().getCode()==1) {
                        ...
                        Intent intent=new Intent(mActivity, NeedPayActivity.class);
