...
import com.qr.bymall.adapter.FinishedOrderAdapter;
...
public class FinishedOrderActivity extends BaseActivity {
    ...
    public void initView() {
        back= (RelativeLayout) findViewById(R.id.finished_order_back);
        recy= (RecyclerView) findViewById(R.id.recy_finished_order);
        adapter=new FinishedOrderAdapter(FinishedOrderActivity.this);
        getOrderList("3", SharedUtil.getToken(getApplicationContext()));
        adapter.setOnItemClickListener(new FinishedOrderAdapter.OnRecyclerViewItemClickListener() {
            @Override
