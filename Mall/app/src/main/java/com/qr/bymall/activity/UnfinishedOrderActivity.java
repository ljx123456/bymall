...
import com.qr.bymall.adapter.UnfinishedOrderAdapter;
...
public class UnfinishedOrderActivity extends BaseActivity {
    ...
    public void initView() {
        back= (RelativeLayout) findViewById(R.id.unfinished_order_back);
        recy= (RecyclerView) findViewById(R.id.recy_unfinished_order);
        adapter=new UnfinishedOrderAdapter(UnfinishedOrderActivity.this);
        getOrderList("2", SharedUtil.getToken(getApplicationContext()));

        adapter.setOnItemClickListener(new UnfinishedOrderAdapter.OnRecyclerViewItemClickListener() {
            @Override
            ...
            public void onResponse(Call<OrderList> call, Response<OrderList> response) {
                if (response.code()==200){
                    if (response.body().getCode()==1) {
                        ...
                        new AlertDialog.Builder(UnfinishedOrderActivity.this)
                                .setTitle("系统提示")
