...
import com.qr.bymall.adapter.PayOrderAdapter;
...
public class PayOrderActivity extends BaseActivity {
    ...
    public void initView() {
        back= (RelativeLayout) findViewById(R.id.pay_order_back);
        recy= (RecyclerView) findViewById(R.id.recy_pay_order);
        adapter=new PayOrderAdapter(PayOrderActivity.this);
        getOrderList("1", SharedUtil.getToken(getApplicationContext()));


        adapter.setOnItemClickListener(new PayOrderAdapter.OnRecyclerViewItemClickListener() {
            @Override
