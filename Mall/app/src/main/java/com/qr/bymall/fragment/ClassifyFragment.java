...
public class ClassifyFragment extends Fragment {
    ...
    private String url = "https://mall.qingrongby.com/home/classify.html";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        wv = (WebView) view.findViewById(R.id.classify_wv);
        tv_search = (TextView) view.findViewById(R.id.tv_classify_search);
        layout_classify= (LinearLayout) view.findViewById(R.id.layout_classify);
        layout_net= (RelativeLayout) view.findViewById(R.id.layout_classify_net);
