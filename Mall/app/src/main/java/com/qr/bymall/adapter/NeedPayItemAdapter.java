...
public class NeedPayItemAdapter extends BaseAdapter {
    private Context context;
    private List<OrderList.DataBean.ProductBean> products;
    public NeedPayItemAdapter(Context context,List<OrderList.DataBean.ProductBean> products) {
